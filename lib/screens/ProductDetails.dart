...
import 'package:paymentgateway/convert_to_json/convert_json.dart';
import 'package:carousel_pro/carousel_pro.dart';
import 'package:paymentgateway/models/Products.dart';
import 'package:paymentgateway/screens/CardDetails.dart';
import 'package:paymentgateway/widget/ExpandText.dart';
...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  void initState() {
    ...
    productDetails = ConvertJson().getProduct();
                ...
                Container(
                  ...
                  child: Tags(
                    ...
                    itemBuilder: (int index) {
                      final item = productDetails.tags[index];
              ...
              children: <Widget>[
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        SizedBox(width: 2,),
                        Text(
                          '${productDetails.rating}(${productDetails.ratingCount})',
                          style: TextStyle(
                              fontSize: 18,
                              color: Colors.black
                          ),
                ...
                Container(
                  ...
                  child: RaisedButton(
                    ...
                    onPressed: (){
                      try {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => CartDetails(productFullDetails: productDetails,)));
                      } catch (e) {
                        debugPrint(e);
                      }
                    },
